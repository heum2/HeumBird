...
export const initialState = {
  ...
  hasMoreFollower: false, // 더보기 팔로워
  hasMoreFollowing: false, // 더보기 팔로잉
};
...
export const ADD_POST_TO_ME = 'ADD_POST_TO_ME'; // 리듀서의 단점 때문에 어쩔수 없이 만들어 낸 옵션?
  ...
  return produce(state, draft => {
    switch (action.type) {
      ...
      case EDIT_NICKNAME_FAILURE: {
        draft.isEditingNickname = false;
        draft.editNicknameErrorReason = acton.error;
        break;
      }
      default: {
        break;
